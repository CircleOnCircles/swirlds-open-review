...
public class Address implements SelfSerializable {
	 ...
	 */
	public Address() {
		this(-1L, "", "", 1, false, null, -1, null, -1, null, -1, null, -1,
				(SerializablePublicKey) null, (SerializablePublicKey) null, (SerializablePublicKey) null, null);
	}
	 ...
	 */
	@Deprecated
	public Address(long id, String nickname, String selfName, long stake,
			boolean ownHost,//
			...
			PublicKey sigPublicKey, PublicKey encPublicKey,
			PublicKey agreePublicKey, String memo) {
		this(id, nickname, selfName, stake, ownHost,
				addressInternalIpv4, portInternalIpv4,
				addressExternalIpv4, portExternalIpv4,
				addressInternalIpv6, portInternalIpv6,
				addressExternalIpv6, portExternalIpv6,
	...
	public Address(long id, String nickname, String selfName, long stake,
			...
			byte[] addressInternalIpv6, int portInternalIpv6, //
			byte[] addressExternalIpv6, int portExternalIpv6, //
			SerializablePublicKey sigPublicKey, SerializablePublicKey encPublicKey,
			SerializablePublicKey agreePublicKey, String memo) {
		this.id = id;
	...
	public boolean isLocalTo(Address a) {
		return Arrays.equals(getAddressExternalIpv4(),
				a.getAddressExternalIpv4());
	}
	 ...
	 */
	public Address copy() {
		return new Address(id, nickname, selfName, stake, ownHost, //
				addressInternalIpv4, portInternalIpv4,//
				addressExternalIpv4, portExternalIpv4, //
				addressInternalIpv6, portInternalIpv6, //
				addressExternalIpv6, portExternalIpv6,//
				sigPublicKey, encPublicKey, agreePublicKey, memo);
	}
	...
	public static String ipString(byte[] ip) {
		return "" + (0xff & ip[0]) + "." + (0xff & ip[1]) + "." + (0xff & ip[2])
				+ "." + (0xff & ip[3]);
	}
	...
	public String toString() {
		return "Address{" +
				...
				", ownHost=" + ownHost +
				", stake=" + stake +
				", addressInternalIpv4=" + Arrays.toString(addressInternalIpv4) +
				", portInternalIpv4=" + portInternalIpv4 +
				", addressExternalIpv4=" + Arrays.toString(addressExternalIpv4) +
				", portExternalIpv4=" + portExternalIpv4 +
				", addressInternalIpv6=" + Arrays.toString(addressInternalIpv6) +
				", portInternalIpv6=" + portInternalIpv6 +
				", portExternalIpv6=" + portExternalIpv6 +
				", addressExternalIpv6=" + Arrays.toString(addressExternalIpv6) +
